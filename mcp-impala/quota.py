...
def _store():
    """admin/store.py. Do not rely on pytest pythonpath; AMP unloads adapter dirs after import."""
    import importlib
    import sys

    admin = str(Path(__file__).resolve().parents[1] / "admin")
