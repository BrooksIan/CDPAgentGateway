...
from agentgateway.amp import build_impala_mcp_app, disabled_mcp_app, serve_cml_app, startup_error_app
if not mcp_adapter_enabled("impala"):
    app = disabled_mcp_app("mcp-impala")
else:
    try:
        app = build_impala_mcp_app()
    except Exception as err:
        app = startup_error_app("mcp-impala", err)
