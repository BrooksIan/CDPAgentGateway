...
from agentgateway.amp import build_mcp_app, disabled_mcp_app, serve_cml_app, startup_error_app
if not mcp_adapter_enabled("spark"):
    app = disabled_mcp_app("mcp-spark")
else:
    try:
        app = build_mcp_app()
    except Exception as err:
        app = startup_error_app("mcp-spark", err)
